...
const AddRecord = () => {
    ...
    const [amount, setAmount] = useState(6.5); // Default value for the slider
    ...
    const clientAction = async (formData: FormData) => {
        ...
        if (error) {
            ...
            setAlertMessage("ঘুমের রেকর্ড সফলভাবে যোগ করা হয়েছে!");
            setAlertType("success"); // Set alert type to success
            formRef.current?.reset();
            setAmount(6.5); // Reset the slider to the default value
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            >
                                <option value="" disabled>
                                    ঘুমের মান নির্বাচন করুন...
                                </option>
                                <option value="Refreshed">🌞 সতেজ</option>
                                <option value="Tired">😴 ক্লান্ত</option>
                                <option value="Neutral">😐 স্বাভাবিক</option>
                                <option value="Exhausted">
                                    😫 অত্যন্ত ক্লান্ত
                                </option>
                                <option value="Energetic">⚡ শক্তিশালী</option>
                            </select>
                        </div>
                        ...
                        <div className="flex-1">
                            ...
                            <input
                                ...
                                id="date"
                                className="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 px-4 py-2"
                                placeholder="একটি তারিখ নির্বাচন করুন"
                                required
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span className="text-xs text-gray-500">
                                (০ থেকে ১২ এর মধ্যে ০.৫ ধাপে নির্বাচন করুন)
                            </span>
                        </label>
                        <input
                            type="range"
